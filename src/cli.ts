...
program
  ...
  .option("--policy-store <path>", "Path to persisted per-model policy JSON")
  .option("--metadata-cache <path>", "Path to cached OpenRouter model metadata JSON")
  .option("--settings-store <path>", "Path to persisted control-plane settings JSON")
  .option("--request-log-store <path>", "Path to persisted request observability JSON")
  .option("--desired-model-store <path>", "Path to persisted desired model JSON")
  .option("--access-key-store <path>", "Path to persisted Local Access Key JSON")
