import type { Endpoint, ModelSummary, ProviderPolicy, Settings } from "./types";
...
export const api = {
  ...
  saveSettings: (settings: Pick<Settings, "mergeMode" | "globalPolicy" | "metadataTtlMs">) => request<Settings>("/settings", { method: "PUT", body: JSON.stringify(settings) }),
};
